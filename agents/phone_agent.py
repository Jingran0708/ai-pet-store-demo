...
_APPOINTMENT_SUBFLOW = (
    ...
    "7. After the date/time are confirmed, the very next thing you ask is for a phone number to send the "
    "confirmation by SMS — do not skip this step or re-ask earlier questions instead. "
